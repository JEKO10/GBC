  ...
  return (
    <>
      <section className="font-outfit px-5 sm:px-8 md:px-16 my-5 sm:my-10">
        ...
        <article className="flex flex-col lg:flex-row items-center gap-8 lg:gap-14 mb-10 md:mb-24 lg:mb-36">
        ...
        <h2 className="text-secondary text-2xl sm:text-3xl font-semibold text-center mt-16 md:mt-24 mb-5 lg:mb-10">
          Why Choose GBC?
        </h2>
