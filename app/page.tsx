  ...
  return (
    <section className="font-outfit px-5 sm:px-8 md:px-16 my-5 sm:my-10">
      <h1 className="text-secondary text-2xl sm:text-3xl md:text-4xl font-semibold text-center my-8 sm:my-12 md:mb-20">
        Welcome to General Bilimoria&apos;s Canteen <br /> Authentic Indian Food
      ...
      <article className="flex flex-col lg:flex-row items-center gap-8 lg:gap-14">
        <div className="lg:w-1/2">
          <p className="text-lg leading-relaxed mb-6">
            ...
            decorated officer of the Indian Army, whose legacy lives on through
            flavors that tell stories of courage, loyalty, and zest for life.
          </p>
          <p className="text-lg leading-relaxed sm:mb-2">
            ...
            affectionately known as &quot;General Billy&quot; – was renowned not
            only for his leadership but also for his warmth, loyalty, and, of
            course, his love of good food. His journeys across the Indian
            subcontinent introduced him to a tapestry of flavors, textures, and
            spices that fueled his affection for the cuisine of the region.
          </p>
        </div>
        ...
        <div>
          <ul className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl space-y-6 sm:space-y-8">
            ...
            <li>
              ...
              <p>
                We research our partner restaurants so you can trust the source
                of every meal, knowing it’s safe and fresh.
              </p>
            </li>
            <li>
              <span className="font-semibold">
              ...
              <p>
                Enjoy meals that are not just convenient but crafted to deliver
                great taste and peace of mind. At GBC, quality is our priority –
