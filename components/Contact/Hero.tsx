...
const Hero = () => {
  return (
    <header
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/contact/contact.png')`,
      }}
    >
      <article className="w-[90%] md:w-full font-outfit max-w-lg text-center bg-primary/65 -mt-24 py-10 px-5 sm:px-14 rounded-md">
        ...
        <ul className="text-center w-full space-y-2 text-sm sm:text-base max-w-lg list-none">
          <li>
            <a
              ...
              className="text-lg underline hover:text-primary transition"
            >
              hello@gbcanteen.com
            </a>
          </li>
